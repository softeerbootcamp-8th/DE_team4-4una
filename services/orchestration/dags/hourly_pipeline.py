...
publish 단계를 추가했다(#227에서 제거). 이슈 #189: 4단계 의존관계를 완성했다. 이슈 #205:
...
with DAG(
    ...
    description="sensor processing -> scoring -> standard -> current 시간배치 파이프라인",
    ...
    sensor_processing >> scoring >> standard_score >> current_score
