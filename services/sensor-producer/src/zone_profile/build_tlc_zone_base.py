...
OUTPUT_COLUMNS = ["location_id", "borough", "zone", "service_zone", "geometry"]
...
def validate(zone_master: gpd.GeoDataFrame) -> None:
    ...
    missing_geometry = zone_master.loc[zone_master["geometry"].isna(), "location_id"]
    unexpected_missing = set(missing_geometry) - NON_SPATIAL_LOCATION_IDS
