...
- PR 본문에 관련 이슈, 변경 이유, 주요 변경 사항, 검증 결과를 작성합니다.
...
3. 테스트 또는 검증 방법과 결과
4. 관련 GitHub Issue
5. 데이터 스키마, 파티션 또는 인프라 변경 여부
6. 필요한 경우 backfill 및 롤백 방법
7. 본문 마지막 줄에 `Closes #이슈번호`
...
- 스키마 변경, backfill, 롤백 방법 등 필요한 설명이 작성되었습니다.
